...
const WhySection = () => (
  <section id="why" className="py-16 bg-gray-900">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="bg-gradient-to-br from-gray-800/80 to-gray-800/60 rounded-xl p-6 text-center hover:shadow-lg hover:shadow-blue-500/10 transition-all border border-gray-700/50">
